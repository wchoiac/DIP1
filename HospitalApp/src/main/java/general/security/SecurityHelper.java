...
public class SecurityHelper {
    ...
    public static boolean verifyECDSASignatureWithContent(ECPublicKey signerPublicKey, byte[] content, byte[] signature, String hashAlgo, String curveName) throws NoSuchAlgorithmException {
    ...
    // SHA256withECDSA implementation
    // input content unlike createECDSASignatureWithHash - automatically hashes
    public static byte[] createECDSASignatureWithContent(ECPrivateKey signerPrivateKey, byte[] content, String hashAlgo, String curveName, int coordinateLength) throws NoSuchAlgorithmException {
...
//		builder.addExtension(Extension.keyUsage,true,new KeyUsage(KeyUsage.digitalSignature|KeyUsage.keyEncipherment));
    ...
    public static String generateSecureToken() {
        return new BigInteger(130, random).toString(32).trim();
    }
    ...
    public static void main(String[] args) throws InvalidAlgorithmParameterException, NoSuchAlgorithmException, IOException, SignatureException, InvalidKeyException {
        ...
        byte[] sig = createECDSASignatureWithHash(privateKey, hash,Configuration.ELIPTIC_CURVE,Configuration.ELIPTIC_CURVE_COORDINATE_LENGTH);
        byte[] sig2 = createECDSASignatureWithContent(privateKey, new byte[]{0},"SHA256"
                , Configuration.ELIPTIC_CURVE,Configuration.ELIPTIC_CURVE_COORDINATE_LENGTH);
        ...
        System.out.println(verifyECDSASignatureWithContent((ECPublicKey) keyPair.getPublic(), new byte[]{0}, sig,"SHA256",Configuration.ELIPTIC_CURVE));
