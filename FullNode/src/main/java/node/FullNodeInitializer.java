 ...
 *
 */
public class FullNodeInitializer {
    public static void main(String[] args) throws IOException, ClassNotFoundException, KeyStoreException, CertificateException, NoSuchAlgorithmException, OperatorCreationException, InvalidKeySpecException, FileCorruptionException, BlockChainObjectParsingException, NoSuchProviderException {
        ...
        while(selection<5&&selection>=0) {
            ...
            System.out.println("2. Generate keystore for signing");
    ...
    public static void createKeyStoreForSigning(Scanner sc) throws NoSuchAlgorithmException, IOException, InvalidKeySpecException, KeyStoreException, CertificateException, NoSuchProviderException {
        ...
        if (Configuration.SIGNING_KEYSTORE_FILE.exists()) {
            ...
            System.out.print("Please enter your signing(authorized) certificate file name: ");
            String signingCertString = sc.next();
            while (!new File(signingCertString).exists()) {
                System.out.print("File doesn't exist, please enter again: ");
                signingCertString = sc.next();
            }
            signingCert = SecurityHelper.getX509FromDER(new File(signingCertString));
    ...
    public static void createCertAndKeyStoreForAPI(Scanner sc) throws OperatorCreationException, CertificateException, IOException, NoSuchAlgorithmException, InvalidKeySpecException, KeyStoreException, NoSuchProviderException {
        ...
        if (Configuration.API_KEYSTORE_FILE.exists()) {
            ...
            X509Certificate apiCert = SecurityHelper.issueCertificate(apiPublicKey, signingPublicKey, signingPrivateKey, noAfter,
                    ...
                    null, BlockChainSecurityHelper.calculateIdentifierFromECPublicKey(signingPublicKey),
    ...
    public static void createCertAndKeyStoreForConnection(Scanner sc) throws OperatorCreationException, CertificateException, IOException, NoSuchAlgorithmException, InvalidKeySpecException, KeyStoreException, NoSuchProviderException {
        ...
        if (Configuration.CONNECTION_KEYSTORE_FILE.exists()) {
            ...
            X509Certificate connectionCert = SecurityHelper.issueCertificate(connectionPublickey, signingPublicKey, signingPrivateKey
                    , noAfter, subjectName,issuerName,
                    null, BlockChainSecurityHelper.calculateIdentifierFromECPublicKey(signingPublicKey),
                    null,Configuration.CONNECTION_CERTIFICATE_SIGNATURE_ALGORITHM, false);
            connectionKeyStore.setKeyEntry(Configuration.CONNECTION_KEYSTORE_ALIAS,connectionPrivateKey,connectionKeyStorePassword,new Certificate[]{connectionCert,signingCert});
